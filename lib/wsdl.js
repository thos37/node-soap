...
WSDL.prototype.findSchemaObject = function(nsURI, qname) {
  //console.log("findSchemaObject",nsURI,qname)
  if (!nsURI || !qname) {
    return null;
  }

  var def = null;
  //console.log("schemas: ", this.definitions.schemas);
...
WSDL.prototype.objectToDocumentXML = function(name, params, nsPrefix, nsURI, type) {
  ...
  //console.log("inside objectToDocumentXML:", parameterTypeObj)
...
WSDL.prototype.objectToRpcXML = function(name, params, nsPrefix, nsURI) {
  ...
  //console.log (name, params, nsPrefix, nsURI);
...
WSDL.prototype.objectToXML = function(obj, name, nsPrefix, nsURI, isFirst, xmlnsAttr, schemaObject, nsContext) {
  //console.log("objectToXML: ", name, nsPrefix, nsURI);
  var self = this;
  var schema = this.definitions.schemas[nsURI];
  ...
  // console.log("prefixNamespace: ", prefixNamespace, "nsURI", nsURI, "isFirst", isFirst)
  ...
  var ns = '';
  if (prefixNamespace && ((qualified || isFirst) || soapHeader) ){
  //&& this.options.ignoredNamespaces.indexOf(nsPrefix) === -1) {
    // prefix element
